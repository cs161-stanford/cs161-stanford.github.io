...
<div class="card mb-4">
  ...
  <div class="card-body">
<p> So cute!!!</p>
        <p> <img src="{{ '/assets/images/hippo1.jpg' | relative_url }}" alt="Hippo1" class="img-fluid"  style="width:40%">   
         <img src="{{ '/assets/images/hippo2.jpg' | relative_url }}" alt="Hippo2" class="img-fluid"  style="width:40%">   
</p>
  </div>
</div>
