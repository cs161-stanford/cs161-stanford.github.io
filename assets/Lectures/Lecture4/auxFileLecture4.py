...
#    - pivotAlg: if myFn takes an argument pivotAlg, you can pass that in with this one
def trySelectABunch(myFn, Ns = range(10,100,10), numTrials=20, listMax = 10, random=True, pivotAlg=None):
    nValues = []
    tValues = []
    for n in Ns:
